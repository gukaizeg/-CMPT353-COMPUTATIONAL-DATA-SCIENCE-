...
usual_results_df.to_csv('../Result Files/fit_results/usual_polynomial_fits.csv', index = False)
during_pandemic_df.to_csv('../Result Files/fit_results/during_pandemic_polynomial_fits.csv', index = False)
augmented_df.to_csv('../Result Files/fit_results/augmented_fits.csv', index = False)
