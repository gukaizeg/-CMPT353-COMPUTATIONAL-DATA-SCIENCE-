...
def fit(region_str):
    ...
    data_corr.to_csv('../Result Files/pandemic/covid_employment_correlations_{}.csv'.format(region_str))
    ...
    plt.title('linear and polynomial fits of {} unemployment\n'
              'rate between 2020-01 and 2023-01'.format(region_str))
    ...
    fig_location = '../Result Files/pandemic/' + region_str + '_polynomial_fits.svg'
