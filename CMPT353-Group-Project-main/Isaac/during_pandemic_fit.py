...
def fit(region_str):
    ...
    data_corr.to_csv('./pandemic/covid_employment_correlations_{}.csv'.format(region_str))
    ...
    plt.title('linear and polynomial fits of {} unemployment rate between 2020-02 and 2022-12'.format(region_str))
    ...
    fig_location = './pandemic/' + region_str + '_polynomial_fits.svg'
