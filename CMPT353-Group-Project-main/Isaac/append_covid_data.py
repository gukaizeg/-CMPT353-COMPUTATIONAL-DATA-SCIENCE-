...
covid_data = pd.read_csv('../covid19-download.csv')
employment_data = pd.read_csv('../combined_reformatted_total_included.csv')
...
combined_data.to_csv('../covid_and_employment_total_included.csv', index = False)